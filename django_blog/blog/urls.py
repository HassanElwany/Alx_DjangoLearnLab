...
urlpatterns = [
    ...
    path('tags/<slug:tag_slug>/', TagPostListView.as_view(), name='posts_by_tag'),  # New URL for filtering posts by tag
     path('tag/<str:tag_name>/', TagPostListView.as_view(), name='tag_posts'),
]
