...
urlpatterns = [
    ...
    path('comment/<int:pk>/edit/', CommentEditView.as_view(), name='edit_comment'),  # For editing a comment
    path('comment/<int:pk>/delete/', CommentDeleteView.as_view(), name='delete_comment'),  # For deleting a comment
]
