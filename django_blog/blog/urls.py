...
urlpatterns = [
    ...
    # Comment URLs
    path('post/<int:post_id>/comment/new/', CommentCreateView.as_view(), name='comment_create'),  # Create comment
    path('comment/<int:pk>/edit/', CommentEditView.as_view(), name='edit_comment'),  # Edit comment
